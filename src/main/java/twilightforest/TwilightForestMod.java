...
public class TwilightForestMod {
	...
	private void registerCreatures() {
		...
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFSwarmSpider.class, "SwarmSpider", idMobSwarmSpider, 0x32022e, 0x17251e);
		...
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFSkeletonDruid.class, "SkeletonDruid", idMobSkeletonDruid, 0xa3a3a3, 0x2a3b17);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFHostileWolf.class, "HostileWolf", idMobHostileWolf, 0xd7d3d3, 0xab1e14);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFWraith.class, "TwilightWraith", idMobTwilightWraith, 0x505050, 0x838383);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFHedgeSpider.class, "HedgeSpider", idMobHedgeSpider, 0x235f13, 0x562653);
		TFCreatures.registerTFCreature(twilightforest.entity.boss.EntityTFHydra.class, "Hydra", idMobHydra, 0x142940, 0x29806b);
		TFCreatures.registerTFCreature(twilightforest.entity.boss.EntityTFLich.class, "TwilightLich", idMobLich, 0xaca489, 0x360472);
		TFCreatures.registerTFCreature(twilightforest.entity.passive.EntityTFPenguin.class, "GlacierPenguin", idMobPenguin, 0x12151b, 0xf9edd2);
		TFCreatures.registerTFCreature(twilightforest.entity.boss.EntityTFLichMinion.class, "LichMinion", idMobLichMinion);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFLoyalZombie.class, "LoyalZombie", idMobLoyalZombie);
		TFCreatures.registerTFCreature(twilightforest.entity.passive.EntityTFTinyBird.class, "TinyBird", idMobTinyBird, 0x33aadd, 0x1188ee);
		TFCreatures.registerTFCreature(twilightforest.entity.passive.EntityTFSquirrel.class, "ForestSquirrel", idMobSquirrel, 0x904f12, 0xeeeeee);
		TFCreatures.registerTFCreature(twilightforest.entity.passive.EntityTFBunny.class, "ForestBunny", idMobBunny, 0xfefeee, 0xccaa99);
		TFCreatures.registerTFCreature(twilightforest.entity.passive.EntityTFRaven.class, "ForestRaven", idMobRaven, 0x000011, 0x222233);
		TFCreatures.registerTFCreature(twilightforest.entity.passive.EntityTFQuestRam.class, "QuestingRam", idMobQuestRam);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFKobold.class, "TwilightKobold", idMobKobold, 0x372096, 0x895d1b);
		//TFCreatures.registerTFCreature(twilightforest.entity.EntityTFBoggard.class, "Boggard", idMobBoggard);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFMosquitoSwarm.class, "MosquitoSwarm", idMobMosquitoSwarm, 0x080904, 0x2d2f21);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFDeathTome.class, "DeathTome", idMobDeathTome, 0x774e22, 0xdbcdbe);
		...
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFFireBeetle.class, "FireBeetle", idMobFireBeetle, 0x1d0b00, 0xcb6f25);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFSlimeBeetle.class, "SlimeBeetle", idMobSlimeBeetle, 0x0c1606, 0x60a74c);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFPinchBeetle.class, "PinchBeetle", idMobPinchBeetle, 0xbc9327, 0x241609);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFMazeSlime.class, "MazeSlime", idMobMazeSlime, 0xa3a3a3, 0x2a3b17);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFRedcapSapper.class, "RedcapSapper", idMobRedcapSapper, 0x575d21, 0xab1e14);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFMistWolf.class, "MistWolf", idMobMistWolf, 0x3a1411, 0xe2c88a);
		...
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFMiniGhast.class, "MiniGhast", idMobMiniGhast, 0xbcbcbc, 0xa74343);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFTowerGhast.class, "TowerGhast", idMobTowerGhast, 0xbcbcbc, 0xb77878);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFTowerGolem.class, "TowerGolem", idMobTowerGolem, 0x6b3d20, 0xe2ddda);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFTowerTermite.class, "TowerTermite", idMobTowerTermite, 0x5d2b21, 0xaca03a);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFTowerBroodling.class, "RedscaleBroodling", idMobTowerBroodling, 0x343c14, 0xbaee02);
		TFCreatures.registerTFCreature(twilightforest.entity.boss.EntityTFUrGhast.class, "TowerBoss", idMobTowerBoss, 0xbcbcbc, 0xb77878);
		...
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFGoblinKnightUpper.class, "UpperGoblinKnight", idMobGoblinKnightUpper);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFGoblinKnightLower.class, "LowerGoblinKnight", idMobGoblinKnightLower, 0x566055, 0xd3e7bc);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFHelmetCrab.class, "HelmetCrab", idMobHelmetCrab, 0xfb904b, 0xd3e7bc);
		TFCreatures.registerTFCreature(twilightforest.entity.boss.EntityTFKnightPhantom.class, "KnightPhantom", idMobKnightPhantom, 0xa6673b, 0xd3e7bc);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFYeti.class, "Yeti", idMobYeti, 0xdedede, 0x4675bb);
		TFCreatures.registerTFCreature(twilightforest.entity.boss.EntityTFYetiAlpha.class, "YetiBoss", idMobYetiBoss, 0xcdcdcd, 0x29486e);
		...
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFIceShooter.class, "StableIceCore", idMobStableIceCore, 0xa1bff3, 0x7000f8);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFIceExploder.class, "UnstableIceCore", idMobUnstableIceCore, 0x9aacf5, 0x9b0fa5);
		TFCreatures.registerTFCreature(twilightforest.entity.boss.EntityTFSnowQueen.class, "SnowQueen", idMobSnowQueen, 0xb1b2d4, 0x87006e);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFTroll.class, "Troll", idMobTroll, 0x9ea98f, 0xb0948e);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFGiantMiner.class, "GiantMiner", idMobGiantMiner, 0x211b52, 0x9a9a9a);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFArmoredGiant.class, "ArmoredGiant", idMobArmoredGiant, 0x239391, 0x9a9a9a);
		TFCreatures.registerTFCreature(twilightforest.entity.boss.EntityTFIceCrystal.class, "IceCrystal", idMobIceCrystal, 0xdce9fe, 0xadcafb);
		TFCreatures.registerTFCreature(twilightforest.entity.EntityTFHarbingerCube.class, "HarbingerCube", idMobHarbingerCube, 0x00000a, 0x8b0000);
